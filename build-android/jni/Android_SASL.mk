...
SASL_DIR := $(CURRENT_DIR)/../../../libetpan/build-android/dependencies/cyrus-sasl
...
plugins/srp.c \
plugins/srp_init.c
SASL_LOCAL_C_INCLUDES := $(SASL_DIR)/src/cyrus-sasl-2.1.26/include \
    $(SASL_DIR)/src/cyrus-sasl-2.1.26/plugins \
    $(SASL_DIR)/src/cyrus-sasl-2.1.26/build-android/include 
 includes = \
    $(CURRENT_DIR)/../include \
...
SASL_LOCAL_SRC_FILES := $(addprefix $(SASL_DIR)/src/cyrus-sasl-2.1.26/, $(sasl_src_files))
LOCAL_SRC_FILES := \
    $(jni_src_files) \
    ...
    $(LIBETPAN_LOCAL_SRC_FILES) $(SASL_LOCAL_SRC_FILES)
...
LOCAL_STATIC_LIBRARIES := ssl crypto icu4c xml2 tidy ctemplate
