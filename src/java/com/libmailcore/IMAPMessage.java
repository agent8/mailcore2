...
public class IMAPMessage extends AbstractMessage {
    ...
    /**
     * After you call this method, htmlParts, plainParts, attachments, inlineAttachments are NonNull values.
     */
    public native void parseParts();

    public native void setHtmlParts(List<AbstractPart> htmlParts);

    public native List<AbstractPart> htmlParts();

    public native void setPlainParts(List<AbstractPart> plainParts);

    public native List<AbstractPart> plainParts();

    public native void setAttachments(List<AbstractPart> attachments);

    public native List<AbstractPart> attachments();

    public native void setInlineAttachments(List<AbstractPart> inlineAttachments);

    public native List<AbstractPart> inlineAttachments();
