...
namespace mailcore {
    ...
    public:
        ...
        virtual void parseParts();

        virtual void setHtmlParts(Array * /* AbstractPart */ htmlParts);

        virtual Array * /* AbstractPart */ htmlParts();

        virtual void setPlainParts(Array * /* AbstractPart */ plainParts);

        virtual Array * /* AbstractPart */ plainParts();

        virtual void setAttachments(Array * /* AbstractPart */ attachments);

        virtual Array * /* AbstractPart */ attachments();   //zhaoshuo: can override super.attachments()?

        virtual void setInlineAttachments(Array * /* AbstractPart */ inlineAttachments);

        virtual Array * /* AbstractPart */ inlineAttachments();
    ...
    private:
        ...
        Array * /* AbstractPart */ mHtmlParts;
        Array * /* AbstractPart */ mPlainParts;
        Array * /* AbstractPart */ mAttachments;
        Array * /* AbstractPart */ mInlineAttachments;
