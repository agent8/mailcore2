...
@property (nonatomic, copy) NSArray * /* NSString */ _Nullable references;

/** In-Reply-To field. It's an array of message-ids.*/
@property (nonatomic, copy) NSArray * /* NSString */ _Nullable inReplyTo;
...
/** Sender field.*/
@property (nonatomic, copy) MCOAddress * _Nullable sender;

/** From field: address of the sender of the message.*/
@property (nonatomic, copy) MCOAddress * _Nullable from;

/** To field: recipient of the message. It's an array of MCOAddress.*/
@property (nonatomic, copy) NSArray * /* MCOAddress */ _Nullable to;

/** Cc field: cc recipient of the message. It's an array of MCOAddress.*/
@property (nonatomic, copy) NSArray * /* MCOAddress */ _Nullable cc;

/** Bcc field: bcc recipient of the message. It's an array of MCOAddress.*/
@property (nonatomic, copy) NSArray * /* MCOAddress */ _Nullable bcc;

/** Reply-To field. It's an array of MCOAddress.*/
@property (nonatomic, copy) NSArray * /* MCOAddress */ _Nullable replyTo;
